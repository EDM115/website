...
# Get NGINX's version
nginx -V  # here 1.30.0, note the flags
...
cd /tmp/nginx-brotli-build/nginx-1.30.0
./configure \
  --prefix=/etc/nginx \
  ...
  --with-cc-opt='-g -O2 -fno-omit-frame-pointer -mno-omit-leaf-frame-pointer -ffile-prefix-map=/home/builder/debuild/nginx-1.30.0/debian/debuild-base/nginx-1.30.0=. -flto=auto -ffat-lto-objects -fstack-protector-strong -fstack-clash-protection -Wformat -Werror=format-security -fcf-protection -fdebug-prefix-map=/home/builder/debuild/nginx-1.28.3/debian/debuild-base/nginx-1.30.0=/usr/src/nginx-1.30.0-1~noble -fPIC' \

          ...
          [
            ...
            },
            {
              ...
              value: function (t) {
                ...
                const c =
                  ((100 / r.width) * (this.config.thumbWidth / 2)) / 100
                return (
                  (i = (100 / r.width) * (n.clientX - r.left)) < 0
                    ? (i = 0)
                    : i > 100 && (i = 100),
                  i < 50
                    ? (i -= (100 - 2 * i) * c)
    ...
    class lt {
      constructor (t) {
        ...
        e(this, 'setTabFocus', (e) => {
          ...
          if (
            (clearTimeout(this.focusTimer), n === 'keydown' && s !== 'Tab')
          ) {
            return
          }
        ...
        e(this, 'container', () => {
          ...
          fe.call(e, i.container, 'enterfullscreen exitfullscreen', (t) => {
            ...
            n();
            (t.type === 'enterfullscreen' ? fe : be).call(
              e,
              window,
              'resize',
              a
      ...
      handleKey (e) {
        ...
        if (c) {
          ...
          if (H(n)) {
            ...
            if (e.key === 'Space' && re(n, 'button, [role^="menuitem"]')) {
              return
            }
          }
          switch (

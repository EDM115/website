...
4) If you just want to change the thumbnail, click on :framed_picture: button. If you *also* want to rename it, click on :framed_picture::pencil2:
5) If you wanted to rename it, send the new filename to the bot when it asks it (pay attention, include the extension)
6) It's done :partying_face: Regardless of the file, pretty fast (DL around 6-10 Mb/s • UL around 25-30 Mb/s) and ~~it works for premium files :smiling_face_with_three_hearts:~~ (lol i don't have premium acc :smiling_face_with_tear:)

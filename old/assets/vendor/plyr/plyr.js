  ...
  (function (e, t) {
    typeof exports === 'object' && typeof module !== 'undefined'
      ...
      : typeof define === 'function' && define.amd
        ? define('Plyr', t)
        : ((e = typeof globalThis !== 'undefined' ? globalThis : e || self).Plyr = t())
  })(this, function () {
    'use strict'
    function e (e, t, i) {
      return (
    ...
    const a = { addCSS: !0, thumbWidth: 15, watch: !0 }
    function l (e, t) {
      return (function () {
          ...
          [
            ...
            },
            {
              ...
              value: function (t) {
                ...
                const a = parseFloat(s.getAttribute('min')) || 0
                const l = parseFloat(s.getAttribute('max')) || 100
                const o = parseFloat(s.getAttribute('step')) || 1
                const r = s.getBoundingClientRect()
                const c = ((100 / r.width) * (this.config.thumbWidth / 2)) / 100
                return (
                  (i = (100 / r.width) * (n.clientX - r.left)) < 0 ? (i = 0) : i > 100 && (i = 100),
                  i < 50 ? (i -= (100 - 2 * i) * c) : i > 50 && (i += 2 * (i - 50) * c),
                  a + w((i / 100) * (l - a), o)
                )
              }
            },
    ...
    const M = (e) => Array.isArray(e)
    const N = (e) => C(e, NodeList)
    const x = (e) =>
      A(e) || ((E(e) || M(e) || N(e)) && !e.length) || (S(e) && !Object.keys(e).length)
    const I = A
    const L = S
    const $ = (e) => k(e) === Number && !Number.isNaN(e)
    const _ = E
    const O = (e) => k(e) === Boolean
    const j = P
    const D = M
    const q = N
    const H = (e) =>
    ...
    const R = (e) => C(e, Event)
    const F = (e) => C(e, KeyboardEvent)
    const V = (e) => C(e, TextTrack) || (!A(e) && E(e.kind))
    const B = (e) => C(e, Promise) && P(e.then)
    const U = (e) => {
    ...
    const me = {
      ...
      check (e, t, i) {
        ...
        return { api: n, ui: n && me.rangeInput && (e !== 'video' || !Y.isIPhone || s) }
      },
      pip: !(
        Y.isIPhone ||
    ...
    function Ne (e) {
      ...
      if (
        ...
        i === null && !W(this.embed) && D(this.embed.ratio) && ({ ratio: i } = this.embed),
        i === null && this.isHTML5)
      ) {
    ...
    const We = {
      ...
      createButton (e, t) {
        ...
        switch (
          ...
          n.element !== 'button' || Object.keys(i).includes('type') || (i.type = 'button'),
      ...
      bindMenuItemShortcuts (e, t) {
        fe.call(
          ...
          (i) => {
            ...
            if ((i.preventDefault(), i.stopPropagation(), i.type === 'keydown')) return
        ...
        fe.call(this, e, 'keyup', (e) => {
          e.key === 'Return' && We.focusFirstMenuItem.call(this, null, !0)
        })
      },
        ...
        if (e) {
          switch (e.type) {
            ...
            case 'seeked':
              ...
              (n = this.duration),
              (t =
                  s === 0 || n === 0 || Number.isNaN(s) || Number.isNaN(n)
                    ? 0
                    : ((s / n) * 100).toFixed(2)),
              e.type === 'timeupdate' && We.setRange.call(this, this.elements.inputs.seek, t)
              break
            case 'playing':
            case 'progress':
      ...
      updateSeekTooltip (e) {
        ...
        (s.style.left = `${l}%`),
        R(e) && ['mouseenter', 'mouseleave'].includes(e.type) && a(e.type === 'mouseenter')
      },
      timeUpdate (e) {
        ...
        (e && e.type === 'timeupdate' && this.media.seeking) || We.updateProgress.call(this, e)
      },
      durationUpdate () {
      ...
      create (e) {
        ...
        return (
          Ce(D(this.config.controls) ? this.config.controls : []).forEach((l) => {
            if (
              (l === 'restart' && c.appendChild(i.call(this, 'restart', h)),
              l === 'rewind' && c.appendChild(i.call(this, 'rewind', h)),
              l === 'play' && c.appendChild(i.call(this, 'play', h)),
              l === 'fast-forward' && c.appendChild(i.call(this, 'fast-forward', h)),
              l === 'progress')
            ) {
            ...
            if (
              (l === 'current-time' && c.appendChild(a.call(this, 'currentTime', h)),
              l === 'duration' && c.appendChild(a.call(this, 'duration', h)),
              l === 'mute' || l === 'volume')
            ) {
              ...
              if (
                ((H(t) && c.contains(t)) ||
                  ...
                  c.appendChild(t)),
                l === 'mute' && t.appendChild(i.call(this, 'mute')),
                l === 'volume' && !Y.isIos)
              ) {
            ...
            if (
              (l === 'captions' && c.appendChild(i.call(this, 'captions', h)),
              l === 'settings' && !W(this.config.settings))
            ) {
              ...
              const a = Z('div')
              const l = Z('div', { id: `plyr-settings-${e.id}-home` })
              const o = Z('div', { role: 'menu' })
              l.appendChild(o),
              a.appendChild(l),
              ...
              this.config.settings.forEach((i) => {
                ...
                const l = Z('span', { class: this.config.classNames.menu.value })
            ...
            if (
              (l === 'pip' && me.pip && c.appendChild(i.call(this, 'pip', h)),
              l === 'airplay' && me.airplay && c.appendChild(i.call(this, 'airplay', h)),
              l === 'download')
            ) {
    ...
    const Ye = {
      ...
      update () {
        ...
        const { active: t, language: i, meta: s, currentTrackNode: n } = this.captions
        ...
        this.isHTML5 &&
          ...
          e
            ...
            .forEach((e) => {
              ...
              s.set(e, { default: e.mode === 'showing' }),
              e.mode === 'showing' && (e.mode = 'hidden'),
    ...
    const Je = 'inline'
    const Ge = { html5: 'html5', youtube: 'youtube', vimeo: 'vimeo' }
    const Ze = 'audio'
    const et = 'video'
    const tt = () => {}
    class it {
    ...
    class st {
      constructor (t) {
        ...
        e(this, 'trapFocus', (e) => {
          if (Y.isIos || !this.active || e.key !== 'Tab') return
    ...
    const at = {
      ...
      checkPlaying (e) {
        ...
        (R(e) && e.type === 'timeupdate') || at.toggleControls.call(this)
      },
      checkLoading (e) {
    ...
    class lt {
      constructor (t) {
        ...
        e(this, 'setTabFocus', (e) => {
          const { player: t } = this
          const { elements: i } = t
          const { key: s, type: n, timeStamp: a } = e
          if ((clearTimeout(this.focusTimer), n === 'keydown' && s !== 'Tab')) return
          n === 'keydown' && (this.lastKeyDown = a)
        ...
        e(this, 'container', () => {
          const { player: e } = this
          const { config: t, elements: i, timers: s } = e
          !t.keyboard.global &&
              t.keyboard.focused &&
        ...
        e(this, 'controls', () => {
          ...
          if (
            ...
            this.bind(t.settings.menu, 'keydown', (t) => {
              t.key === 'Escape' && We.toggleMenu.call(e, t)
            }),
      ...
      handleKey (e) {
        const { player: t } = this
        const { elements: i } = t
        const { key: s, type: n, altKey: a, ctrlKey: l, metaKey: o, shiftKey: r } = e
        const c = n === 'keydown'
        const h = c && s === this.lastKey
        if (a || l || o || r) return
        if (!s) return
        if (c) {
          ...
          if (H(n)) {
            ...
            const { seek: a } = i.inputs
            if (n !== a && re(n, s)) return
            if (e.key === 'Space' && re(n, 'button, [role^="menuitem"]')) return
          }
          switch (
            ([
              'Space',
    ...
    const ot = (function (e, t) {
      ...
      e.exports = (function () {
        ...
        function o (t, i, s, n) {
          ...
          const r = document
          const c = s.async
          const h = (s.numRetries || 0) + 1
          const u = s.before || e
          const d = t.replace(/[\?|#].*$/, '')
          const m = t.replace(/^(css|img)!/, '')
          ;(n = n || 0),
          /(^css!|\.css$)/.test(d)
    ...
    const ht = {
      ...
      ready () {
        ...
        const { premium: i, referrerPolicy: s, ...n } = t
        ...
        e.embed.on('progress', (t) => {
          ...
          parseInt(t.percent, 10) === 1 && ve.call(e, e.media, 'canplaythrough'),
          e.embed.getDuration().then((t) => {
            t !== e.media.duration &&
                  ((e.media.duration = t), ve.call(e, e.media, 'durationchange'))
          })
      ...
      setup () {
        this.media
          ? (le(this.elements.container, this.config.classNames.type.replace('{0}', this.type), !0),
            ...
            this.isEmbed &&
              le(this.elements.container, this.config.classNames.type.replace('{0}', 'video'), !0),
            this.isVideo &&
              ...
              this.cuePoints.forEach((e) => {
                if (e !== 0 && e !== -1 && e < this.player.duration) {
                  ...
                  if (H(t)) {
                    ...
                    const s = Z('span', { class: this.player.config.classNames.cues })
    ...
    class vt {
      constructor (t) {
        ...
        e(this, 'startMove', (e) => {
          if (
            ...
            if (e.type === 'touchmove') {
              ...
              const n = (100 / s.width) * (e.pageX - s.left)
              ...
              const a =
                  (t = this.player.config.markers) === null ||
                  void 0 === t ||
                  (i = t.points) === null ||
                  void 0 === i
                    ? void 0
        ...
        e(this, 'startScrubbing', (e) => {
          ;(I(e.button) || !1 === e.button || e.button === 0) &&
              ((this.mouseDown = !0),
              this.player.media.duration &&
        ...
        e(this, 'setThumbContainerPos', () => {
          ...
          const { container: i } = this.elements.thumb
          const s = t.left - e.left + 10
          const n = t.right - e.left - i.clientWidth - 10
          const a = this.mousePosX - e.left - i.clientWidth / 2
          const l = ft(a, s, n)
          ...
          ? (Le.cancelRequests.call(this),
            this.destroy.call(
              ...
              () => {
                ...
                const [{ provider: s = Ge.html5, src: n }] = t
                const a = s === 'html5' ? i : 'div'
                const l = s === 'html5' ? {} : { src: n }
                Object.assign(this, {
                  provider: s,
                  type: i,
            ...
            this.isHTML5
              ...
              : this.isYouTube
                ? (clearInterval(this.timers.buffering),
                  ...
                  this.embed !== null && j(this.embed.destroy) && this.embed.destroy(),
                  i())
                : this.isVimeo &&
                  (this.embed !== null && this.embed.unload().then(i), setTimeout(i, 200))
          }),

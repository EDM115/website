  ...
  return (
    (e = {
      638: function (e) {
        ...
        function o (e) {
          ...
          for (const n in e) {
            if (t == {} || t.hasOwnProperty(n)) {
              const o = c(e[n])
              ;(r[n] = o),
              n.match(/duration|pulse/) && (r[n] = typeof o !== 'boolean' ? 1e3 * o : o)
            }
          }
        ...
        function i (e, t) {
          ...
          var i = setInterval(function () {
            const a = (function (e, t) {
              const r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 'inc'
              return (e = c(e)), (t = c(t)), parseFloat(r === 'inc' ? e + t : e - t)
            })(o, r, n)
            ;(e.innerHTML = u(a, t)),
            (((o = a) >= t.end && n == 'inc') || (o <= t.end && n == 'dec')) &&
        ...
        function u (e, t) {
          const r = { minimumFractionDigits: t.decimals, maximumFractionDigits: t.decimals }
          ...
          return (
            (e = (function (e, t) {
              if (t.filesizing || t.currency) {
                e = Math.abs(Number(e))
                let r = 1e3
                const n = t.currency && typeof t.currency === 'string' ? t.currency : ''
                const o = t.decimals || 1
                let i = ['', 'K', 'M', 'B', 'T']
                let u = ''
                t.filesizing && ((r = 1024), (i = ['bytes', 'KB', 'MB', 'GB', 'TB']))
                for (let c = 4; c >= 0; c--) {
                  if ((c === 0 && (u = ''.concat(e.toFixed(o), ' ').concat(i[c])), e >= a(r, c))) {
            ...
            (function (e, t) {
              if (t.formater) {
                const r = t.separator ? (typeof t.separator === 'string' ? t.separator : ',') : ''

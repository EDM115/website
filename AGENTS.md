...
│   │   ├── home/blog          # Blog related components
...
A bit of code is compiled to WebAssembly using `assemblyscript`. Some other WebAssembly files are generated by `docfind` for fast keyword search in blog posts.  
